...
local function showPreview()
    ...
    previewProp = CreateObjectNoOffset(propModel, playerCoords.x, playerCoords.y, playerCoords.z, false, false, false)
...
local function pickupProp()
    ...
    if object and DoesEntityExist(object) then
        ...
        local objNetId = NetworkGetNetworkIdFromEntity(object)
        TriggerServerEvent("blrp:pickupProp", objNetId)
...
local function placeProp()
    if holdingProp then
        ...
        TriggerServerEvent("blrp:placeProp", propModel, finalCoords, previewRotation)
